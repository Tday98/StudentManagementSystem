...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Adding menu items to OS menu-bar
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This app was designed as a playground to learn SQL functions use sqlite3
        Feel free to play with the code to make it more efficient!
        """
